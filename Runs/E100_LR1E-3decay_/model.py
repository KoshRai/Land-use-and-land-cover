...
xpath='/home/20bce131/20bce131/data/img_dir'
ypath='/home/20bce131/20bce131/data/ann_dir_8bit'
trn_hist_path='/home/20bce131/20bce131/train_hist'
trn_out_path='/home/20bce131/20bce131/trn_imgs_out'
val_out_path='/home/20bce131/20bce131/val_imgs_out'
...
class SARData(Dataset):
    ...
    def __getitem__(self, idx):
        return self.transforms(self.xtrain[idx]), self.transforms(self.ytrain[idx])
...
idx = torch.randint(0, val_size, (3,))
model.to('cpu')
model.eval()
for i in (idx):
...
idx = torch.randint(0, train_size, (3,))
model.to('cpu')
model.eval()
for i in (idx):
